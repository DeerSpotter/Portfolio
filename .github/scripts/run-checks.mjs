...
try {
  ...
  await run('Syntax: ship continuity browser proof', process.execPath, ['--check', 'verify-ship-smoothness-browser.mjs']);
  ...
  await run('Stable ship continuity at known-good speed', process.execPath, ['verify-ship-smoothness-browser.mjs']);
